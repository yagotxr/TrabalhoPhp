   ...
   class AviaoController extends BaseController {
        ...
        */
        private function getAllAviao() {
            ...
            $resultAviao = $this->aviaoDAO->getAllAviao();
        ...
        */
        public function request() {
            ...
            if (isset($_POST["modelo"])) $this->aviao->modelo = $_POST["modelo"];
            if (isset($_POST["ano"])) $this->aviao->ano = $_POST["ano"];
            ...
            switch ($optCommand) {
                case 'CREATE' :
                    ...
                    // Mensagem
                    $this->view->showMessage("Aviao adicionado!");
                    break;
                case 'UPDATE' :
